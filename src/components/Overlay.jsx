...
export default function Overlay({ scrollContainerRef }) {
  ...
  const y2 = useTransform(scrollYProgress, [0.2, 0.5], ["50vh", "-100vh"]);
  const opacity2 = useTransform(scrollYProgress, [0.2, 0.3, 0.4, 0.5], [0, 1, 1, 0]);

  // Section 3: Sub-tagline & CTAs (45% to 80%)
  const y3 = useTransform(scrollYProgress, [0.45, 0.8], ["50vh", "-100vh"]);
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-[500vh] pointer-events-none z-10">
      <div className="sticky top-0 flex items-center justify-center h-[100dvh] w-full overflow-hidden">
        
        {/* Section 1 */}
        <motion.div style={{ y: y1, opacity: opacity1 }} className="absolute inset-0 flex items-center justify-center px-4">
        ...
        {/* Section 2 */}
        <motion.div style={{ y: y2, opacity: opacity2 }} className="absolute inset-0 flex items-center justify-start px-[5%] md:px-[10%]">
        ...
        {/* Section 3 */}
        <motion.div style={{ y: y3, opacity: opacity3 }} className="absolute inset-0 flex items-center justify-center md:justify-end px-[5%] md:px-[10%] pointer-events-auto">
          <div className="text-center md:text-right w-full max-w-2xl">
